...
export default function ApproveModal({ isOpen, onClose, onSubmit, loading = false }: ApproveModalProps) {
    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-6 border-b border-gray-200">
          <h2 className="text-2xl font-semibold text-gray-900">Approve Request</h2>
          <button
            onClick={handleClose}
            disabled={loading}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <div className="mb-6">
            ...
            <textarea
              placeholder="Enter comments for approve..."
              value={comment}
